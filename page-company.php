  ...
  <main class="site-main">
      ...
      <section class="company__overview">
        ...
        <table>
          ...
          <tr>
            <th>本社</th>
            <td>〒104-0043 東京都中央区湊2-14-1　リベルタ銀座イースト2F</td>
          </tr>
          <tr>
            <th>設立</th>
      ...
      <section class="company__history">
        ...
        <div class="company__historyDetails">
          <dl>
            <dt>2017年9月</dt>
            <dd>個人事業主として事業を行なっていた2人が、結婚を機に会社を設立</dd>
          </dl>
          <dl>
            <dt>2019年3月</dt>
            <dd>本社兼レンタルスペース「花庭サロン」を東京中央区にオープン</dd>
          </dl>
          <dl>
            <dt>2020年12月</dt>
            <dd>シェアオフィス・コワーキングスペース「Mamori」を京都にオープン</dd>
          </dl>
        </div>
      </div>
    </section>
