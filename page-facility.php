...
?>
  ...
  <main class="site-main">
      ...
      <section class="facility__floormap">
        ...
        <picture>
          <!-- <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/facility/floor_map-sp.webp" media="(max-width: 480px)" type="image/webp">
					<source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/facility/floor_map-sp.png" media="(max-width: 480px)"> -->
        ...
        <p class="facility__floormapParagraph">【席数25席】 様々な働き方のニーズにあわせて定員4名／定員2名の「ミーティングルーム」を併設、<br>Wi-Fi・フリードリンク等を備えた「コワーキングスペース」（ラウンジ）をご用意しております。</p>
      </section>
      <picture>
        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/facility/vrview.webp" type="image/webp">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/facility/vrview.png" alt="" class="facility__vrView">
      </picture>
      <section class="facility__photo">
        ...
        <div class="facility__photoBlock">
          ...
          <div class="facility__photoDescription">
            ...
            <p class="facility__photoParagraph">
              深い森をイメージしたメインフロアは、静寂に包まれた癒しと集中の空間。一般的なカフェと比較して、ひとりひとりのスペースを２倍近く取っているため周りの人の目を気にせず集中することができます。丸太のパーテーションで区切られた半個室やオープンスペースなど、お好みに合わせたお席をお選びください。
            </p>
          </div>
        </div>
        <div class="facility__photoBlock">
      ...
      <section class="facility__about">
        ...
        <h3 class="facility__environment">環境</h3>
        <ul class="facility__aboutList">
        ...
        <h3 class="facility__service">サービス</h3>
        <ul class="facility__aboutList">
          <li class="facility__aboutItem">
      ...
      <a href="<?php echo home_url('/contact/') ?>" class="facility__link">お問合せフォーム</a>
    </div>
	</main><!-- #main -->
