...
<aside class="bottom-conversion" id="bottom-conversion">
	<a href="<?php echo home_url(); ?>" class="bottom-conversion-link -tel">
	...
	<a href="<?php echo home_url(); ?>" class="bottom-conversion-link -contact">
		<span class="bottom-conversion-text -en">CONTACT</span><span class="bottom-conversion-text -ja">(お問い合わせ)</span>
	</a>
	<a href="<?php echo home_url(); ?>" class="bottom-conversion-link -mypage">
